...
class FirebaseFunctionAssignOrder extends Command
{
     ...
     * @var string
     */
    protected $signature = 'order:fb-assign';
     ...
     * @var string
     */
    protected $description = 'Find driver to assign order to through firebase cloud function';
    ...
    public function handle()
    {
        ...
        //loop through orders and assign to driver

...
<div>
    ...
    <div x-data="{ open: @entangle('showCreate') }">
        <x-modal-lg confirmText="{{ __('Save') }}" action="save" :clickAway="false">
            ...
            {{--  fees  --}}
            <x-select2 title="{{ __('Fees') }}" :options="$fees ?? []" name="feesIDs" id="feesSelect2" :multiple="true" width="100" :ignore="true" />
            <hr class="mt-4" />
    ...
    <div x-data="{ open: @entangle('showEdit') }">
        <x-modal-lg confirmText="{{ __('Update') }}" action="update" :clickAway="false">
            ...
            {{--  fees  --}}
            <x-select2 title="{{ __('Fees') }}" :options="$fees ?? []" name="feesIDs" id="editFeesSelect2" :multiple="true" width="100" :ignore="true" />
            <hr class="mt-4" />
            @endrole

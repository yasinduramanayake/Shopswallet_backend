<div>
    ...
    <x-baseview title="{{ __('Web App Settings') }}">
        ...
        <x-form action="saveAppSettings" backPressed="$emitUp('goBack')">
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                <div class="">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">{{ __('Note: Notifications, mails etc will be sent in this selected language') }}</p>
                    </div>
                    <div>

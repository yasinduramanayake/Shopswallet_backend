            ...
            <div class="">
                ...
                <div class='grid grid-cols-1 gap-4 mb-10 md:grid-cols-2 lg:grid-cols-3'>
                    ...
                    <div class="block mt-4 text-sm">
                        ...
                        <p class="mt-2 text-xs italic">{{ __('Enable this if you want system to only calculate system commission from delivery fee and vendor order amount with the assumption that driver has paid for order') }}</p>
                ...
                <div class='grid grid-cols-1 gap-4 mb-10 md:grid-cols-2 lg:grid-cols-3'>
                    <x-input title="{{ __('Amount To 1 Point') }}" hint="{{ __('This is the amount that will be rewared with 1 point. e.g Set 0.001 if you want every') }} {{ setting('currency','$') }} {{ __('0.001 spent to be rewarded with 1 point') }}" name="amount_to_point" />
                    <x-input title="{{ __('1 Point To Amount') }}" hint="{{ __('This is the amount that 1 point can be converted to. e.g Set 0.0001 if you want every 1 point to be convertable to 0.001 and credited to user wallet') }}" name="point_to_amount" />
                    <div class="block mt-4 text-sm">
                        <p></p>

<button id="{{ $name }}-selected" type="button" class="{{ $styles['searchSelectedOption'] }}"
    x-on:keydown.enter.prevent="removeSelection(@this)" x-on:keydown.space.prevent="removeSelection(@this)">
    ...
    <span type="button" wire:click.prevent="selectValue(null)">
